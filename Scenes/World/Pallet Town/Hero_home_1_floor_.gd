...
onready var second_floor = preload("res://Scenes/World/Pallet Town/Hero_home_2_floor_.tscn")
...
func _ready() -> void:
	...
	if PlayerData.first_time==true:
		$NPC.number_of_character_in_dialogue="Mother"
	elif PlayerData.first_time==false:
		$NPC.number_of_character_in_dialogue = "Mother2"
