...
func _ready() -> void:
	...
	PlayerData.is_in[1]="res://Scenes/World/Pallet Town/Oak's_Lab_before_and_after_getting_pokemon.tscn"
	$Door.next_scene = scene
	if PlayerData.first_time == true:
		$Rival.number_of_character_in_dialogue = "Rival_at_lab"
		$Oak.free()
	else:
		$Rival.free()
		$Oak.number_of_character_in_dialogue = "Oak_regular"
