...
var route12=load("res://Scenes/World/Routes/Route 12.tscn")
var route14=load("res://Scenes/World/Routes/Route 14.tscn")


func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.route13
	PlayerData.is_in[0] = "Route13"
	PlayerData.is_in[1] = "res://Scenes/World/Routes/Route 13.tscn"
