...
onready var route10 = preload("res://Scenes/World/Routes/Route 10.tscn")


func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.route9
	PlayerData.is_in[0] = "Route9"
	PlayerData.is_in[1] = "res://Scenes/World/Routes/Route 9.tscn"
