...
var prev = load("res://Scenes/World/Saffron City/Silph Co P3.tscn")
var next = preload("res://Scenes/World/Saffron City/Silph Co P5.tscn")

func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.saffron_city
	PlayerData.is_in[0] = "SaffronCity"
	PlayerData.is_in[1] = "res://Scenes/World/Saffron City/Silph Co P4.tscn"
