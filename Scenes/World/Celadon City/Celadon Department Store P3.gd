...
var prev_floor = load("res://Scenes/World/Celadon City/Celadon Department Store P2.tscn")
var next_floor = load("res://Scenes/World/Celadon City/Celadon Department Store P4.tscn")


func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.celadon_city
	PlayerData.is_in[0] = "CeladonCity"
	PlayerData.is_in[1] = "res://Scenes/World/Celadon City/Celadon Department Store P3.tscn"
