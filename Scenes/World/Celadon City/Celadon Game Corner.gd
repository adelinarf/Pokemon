...
var secret = load("res://Scenes/World/Celadon City/Rocket Hideout B1F.tscn")
...
func _ready():
	...
	PlayerData.is_in[1] = "res://Scenes/World/Celadon City/Celadon Game Corner.tscn"
	PlayerData.show_right_dialogue($"Trainer Rocket")
	$SecretEntrance.next_scene = secret
