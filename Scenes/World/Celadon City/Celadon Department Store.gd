...
var next_floor = load("res://Scenes/World/Celadon City/Celadon Department Store P1.tscn")
var elevator = load("res://Scenes/World/Celadon City/Celadon Department Store P1.tscn") 
#CHANGE ELEVATOR WITH A SCENE FOR THE ELEVATOR

func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.celadon_city
	PlayerData.is_in[0] = "CeladonCity"
	PlayerData.is_in[1] = "res://Scenes/World/Celadon City/Celadon Department Store.tscn"
	$"Main door".next_scene = celadon_city
	$Stairs.next_scene = next_floor
	$Elevator.next_scene = elevator
