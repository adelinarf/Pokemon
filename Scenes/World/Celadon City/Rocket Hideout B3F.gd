...
var prev_scene = load("res://Scenes/World/Celadon City/Rocket Hideout B2F.tscn")
var next_scene = load("res://Scenes/World/Celadon City/Rocket Hideout B4F.tscn")

func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.celadon_city
	PlayerData.is_in[0] = "CeladonCity"
	PlayerData.is_in[1] = "res://Scenes/World/Celadon City/Rocket Hideout B3F.tscn"
