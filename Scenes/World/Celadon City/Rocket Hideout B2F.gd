...
var next_scene = load("res://Scenes/World/Celadon City/Rocket Hideout B3F.tscn")
var prev_scene = load("res://Scenes/World/Celadon City/Rocket Hideout B1F.tscn")

func _ready():
	PlayerData.current_dialogue = PlayerData.dialogue.celadon_city
	PlayerData.is_in[0] = "CeladonCity"
	PlayerData.is_in[1] = "res://Scenes/World/Celadon City/Rocket Hideout B2F.tscn"
	PlayerData.show_right_dialogue($"Trainer 4")
	PlayerData.show_right_dialogue($"Trainer 5")
	$upstairs.next_scene = prev_scene
	$upstairs2.next_scene = prev_scene
